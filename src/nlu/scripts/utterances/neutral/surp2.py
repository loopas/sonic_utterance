...
transp = Message('control_change', channel = 4, control = 12, value = 17)
rate = Message('control_change', channel = 5, control = 12, value = 33)
length = Message('control_change', channel = 6, control = 12, value = 67)
amo = Message('control_change', channel = 8, control = 12, value = 64)
